...
export const DEALS: FixtureRecord[] = [
  { id: "d-001", fields: { dealname: "Meridian Health — annual renewal", amount: 128400, closedate: "2026-07-31", dealstage: "Contract sent", pipeline: "Sales pipeline", next_step: "Countersign and schedule kickoff with clinical ops.", deal_owner: "Demo rep", renewal_date: "2026-08-01", deal_type: "Renewal", forecast_amount: 115560, health_score: 86, commission: 12840, loss_reason: null, company: "Meridian Health Systems" } },
  ...
  { id: "d-006", fields: { dealname: "Helix Biotech — platform", amount: 55000, closedate: "2026-08-21", dealstage: "Qualification", pipeline: "Sales pipeline", next_step: null, deal_owner: "Demo rep", renewal_date: null, deal_type: "New business", forecast_amount: 16500, health_score: 61, commission: 5500, loss_reason: null, company: "Helix Biotech" } },
  ...
  { id: "d-009", fields: { dealname: "Quarry & Co — data add-on", amount: 38500, closedate: "2026-10-02", dealstage: "Discovery", pipeline: "Sales pipeline", next_step: null, deal_owner: "Demo rep", renewal_date: null, deal_type: "Expansion", forecast_amount: 7700, health_score: 52, commission: 3850, loss_reason: null, company: "Quarry & Co" } },
  ...
  { id: "d-012", fields: { dealname: "Pinebrook Schools — district license", amount: 150000, closedate: "2026-06-20", dealstage: "Closed won", pipeline: "Sales pipeline", next_step: null, deal_owner: "Demo rep", renewal_date: "2027-06-20", deal_type: "New business", forecast_amount: 150000, health_score: 92, commission: 15000, loss_reason: null, company: "Pinebrook Schools" } },
  ...
  { id: "d-015", fields: { dealname: "Atlas Freight — starter", amount: 12750, closedate: "2026-10-09", dealstage: "Qualification", pipeline: "Sales pipeline", next_step: null, deal_owner: "Demo rep", renewal_date: null, deal_type: "New business", forecast_amount: 3825, health_score: 57, commission: 1275, loss_reason: null, company: "Atlas Freight" } },
];
